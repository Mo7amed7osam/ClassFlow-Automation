...
internal sealed class DesktopWaitingRoomUiaAdmitter
{
    ...
    private static bool TryAdmitFromRoot(AutomationElement root, CancellationToken cancellationToken)
    {
    ...
    private static void RevealRow(AutomationElement row)
    {
        try
        {
    ...
    private static bool TryInvokeRowAction(AutomationElement row, string actionName, string participant)
    {
