...
export default defineConfig({
  ...
  build: {
    ...
    emptyOutDir: true,
    sourcemap: false,
    rollupOptions: { input: { index: resolve(import.meta.dirname, 'index.html'), dashboard: resolve(import.meta.dirname, 'dashboard.html'), roster: resolve(import.meta.dirname, 'roster.html'), welcome: resolve(import.meta.dirname, 'welcome.html') } },
  },
