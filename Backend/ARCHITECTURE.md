...
| `run_delegations` (migration `0009_delegated_runs`) | `coordinator_id` uuid PK → users, `enabled`, `lms_account_id` → lms_accounts, `zoom_account`, `created_by`, `created_at`, `updated_at` |
